  ...
  public class ReplaceItem
  {
    ...
    public void ReplaceProperty(SearchJob job, SerializedProperty prop, SearchResult result)
    {
      if(job.options.searchType == SearchType.SearchAndReplace)
      {
        ...
        if(result.actionTaken != SearchAction.ObjectSwapped)
        {
        ...
        }else if(result.actionTaken != SearchAction.InstanceFound && result.actionTaken != SearchAction.RanScript && result.actionTaken != SearchAction.InstanceNotReplaced){
